        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumPossibleDeposit = table.Column<double>(type: "float", nullable: false),
                    MaximumPossibleDeposit = table.Column<double>(type: "float", nullable: false),
                    MinimumReturn = table.Column<double>(type: "float", nullable: false),
                    MaximumReturn = table.Column<double>(type: "float", nullable: false),
                    GiftBonus = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedCharges = table.Column<double>(type: "float", nullable: false),
                    ChargesPercentage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Duration = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceivingModes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserProfiles_AbpUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deposits_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notification_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CurrentPackage = table.Column<bool>(type: "bit", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_InvestmentPlans_InvestmentPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfitLossRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfitLossRecords_InvestmentPlans_InvestmentPlanId",
                        column: x => x.InvestmentPlanId,
                        principalTable: "InvestmentPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProfitLossRecords_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Referrals_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "SubscriptionTrades",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MT4Id = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AccountType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Leverage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTrades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTrades_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Verifications_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BTCAddress = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ETHAddress = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    LTCAddress = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    UserProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WithdrawalInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WithdrawalInfos_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReceivingModeId = table.Column<int>(type: "int", nullable: false),
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "MiscellaneousTransactions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiscellaneousTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MiscellaneousTransactions_InvestmentPlans_PackageId",
                        column: x => x.PackageId,
                        principalTable: "InvestmentPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MiscellaneousTransactions_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MiscellaneousTransactions_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposits_UserProfileId",
                table: "Deposits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestmentPlans_PlanName",
                table: "InvestmentPlans",
                column: "PlanName",
                unique: true,
                filter: "[PlanName] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_MiscellaneousTransactions_PackageId",
                table: "MiscellaneousTransactions",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_MiscellaneousTransactions_UserProfileId",
                table: "MiscellaneousTransactions",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_InvestmentPlanId",
                table: "Packages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfitLossRecords_InvestmentPlanId",
                table: "ProfitLossRecords",
                column: "InvestmentPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfitLossRecords_UserProfileId",
                table: "ProfitLossRecords",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceivingModes_Type",
                table: "ReceivingModes",
                column: "Type",
                unique: true,
                filter: "[Type] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Referrals_ClientName",
                table: "Referrals",
                column: "ClientName",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Referrals_UserProfileId",
                table: "Referrals",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTrades_MT4Id",
                table: "SubscriptionTrades",
                column: "MT4Id",
                unique: true,
                filter: "[MT4Id] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTrades_UserProfileId",
                table: "SubscriptionTrades",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Verifications_UserProfileId",
                table: "Verifications",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalInfos_AccountNumber",
                table: "WithdrawalInfos",
                column: "AccountNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalInfos_BTCAddress",
                table: "WithdrawalInfos",
                column: "BTCAddress",
                unique: true,
                filter: "[BTCAddress] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalInfos_ETHAddress",
                table: "WithdrawalInfos",
                column: "ETHAddress",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalInfos_LTCAddress",
                table: "WithdrawalInfos",
                column: "LTCAddress",
                unique: true,
                filter: "[LTCAddress] IS NOT NULL");
