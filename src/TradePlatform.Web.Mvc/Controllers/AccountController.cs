...
using TradePlatform.Sessions;
using TradePlatform.Web.Models.Account;
using TradePlatform.Web.Views.Shared.Components.TenantChange;

namespace TradePlatform.Web.Controllers
{
    public class AccountController : TradePlatformControllerBase
    {
