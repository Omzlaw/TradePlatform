...
{
    public abstract class TradePlatformWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TradePlatformWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TradePlatformWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TradePlatformDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TradePlatformDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TradePlatformDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TradePlatformDbContext, Task<T>> func)
        {
            T result;
